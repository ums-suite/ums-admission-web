...
export const EN_TRANSLATIONS: TranslationDictionary = {
  ...
  'officer.campaign.title': 'Campaign configuration',
  'officer.campaign.loadError': 'We could not load that campaign. Please check the id.',
  'officer.campaign.load.title': 'Load an existing campaign',
  'officer.campaign.load.label': 'Campaign id',
  'officer.campaign.load.action': 'Load',
  'officer.campaign.create.title': 'Create a new campaign',
  'officer.campaign.create.name': 'Campaign name',
  'officer.campaign.create.programIds': 'Program ids',
  'officer.campaign.create.programIdsHint': 'Comma-separated program ids.',
  'officer.campaign.create.windowStart': 'Application window start',
  'officer.campaign.create.windowEnd': 'Application window end',
  'officer.campaign.create.applicationFeeType': 'Application fee type',
  'officer.campaign.create.confirmationFeeType': 'Confirmation fee type',
  'officer.campaign.create.submit': 'Create campaign',
  'officer.campaign.create.validationError':
    'Please enter a campaign name and at least one program id.',
  'officer.campaign.create.serverError': 'We could not create the campaign. Please try again.',
  'officer.campaign.summary.window': 'Application window',
  'officer.campaign.summary.requiredDocuments': 'Required documents',
  'officer.campaign.eligibilityRule.title': 'Add an eligibility rule',
  'officer.campaign.eligibilityRule.programId': 'Program id',
  'officer.campaign.eligibilityRule.minimumScore': 'Minimum score',
  'officer.campaign.eligibilityRule.isGpaScale': 'Score is on a GPA scale',
  'officer.campaign.eligibilityRule.requiredBoard': 'Required board (optional)',
  'officer.campaign.eligibilityRule.submit': 'Add rule',
  'officer.campaign.seatQuota.title': 'Add a seat quota',
  'officer.campaign.seatQuota.programId': 'Program id',
  'officer.campaign.seatQuota.quota': 'Seat quota',
  'officer.campaign.seatQuota.submit': 'Add quota',
  'officer.campaign.requiredDocument.title': 'Add a required document type',
  'officer.campaign.requiredDocument.label': 'Document type',
  'officer.campaign.requiredDocument.submit': 'Add document type',

  'officer.questionBank.title': 'Question bank & exam rules',
  'officer.questionBank.createTest.title': 'Create the admission test for this campaign',
  'officer.questionBank.createTest.name': 'Test name',
  'officer.questionBank.createTest.duration': 'Duration (minutes)',
  'officer.questionBank.createTest.submit': 'Create test',
  'officer.questionBank.totalQuestions': 'Total questions',
  'officer.questionBank.totalSlots': 'Total slots',
  'officer.questionBank.addQuestion.title': 'Add a question',
  'officer.questionBank.addQuestion.category': 'Category',
  'officer.questionBank.addQuestion.difficulty': 'Difficulty',
  'officer.questionBank.addQuestion.text': 'Question text',
  'officer.questionBank.addQuestion.options': 'Options',
  'officer.questionBank.addQuestion.optionsHint': 'Comma-separated options.',
  'officer.questionBank.addQuestion.isSubjective': 'This is a subjective (written-answer) question',
  'officer.questionBank.addQuestion.maxScore': 'Maximum score',
  'officer.questionBank.addQuestion.submit': 'Add question',
  'officer.questionBank.selectionRule.title': 'Add a question-selection rule',
  'officer.questionBank.selectionRule.difficulty': 'Difficulty',
  'officer.questionBank.selectionRule.count': 'Number of questions',
  'officer.questionBank.selectionRule.submit': 'Add rule',
  'officer.questionBank.slot.title': 'Add a test slot',
  'officer.questionBank.slot.startAt': 'Start time',
  'officer.questionBank.slot.endAt': 'End time',
  'officer.questionBank.slot.capacity': 'Capacity',
  'officer.questionBank.slot.submit': 'Add slot',

  'officer.meritList.title': 'Merit list',
  'officer.meritList.loading': 'Loading the merit list…',
  'officer.meritList.notFound': 'No merit list has been generated for this campaign yet.',
  'officer.meritList.generate': 'Generate merit list',
  'officer.meritList.generating': 'Generating…',
  'officer.meritList.status': 'Status',
  'officer.meritList.entries': 'Entries',
  'officer.meritList.entry.rank': 'Rank',
  'officer.meritList.entry.outcome': 'Outcome',
  'officer.meritList.approve': 'Approve merit list',
  'officer.meritList.approving': 'Approving…',
  'officer.meritList.approveWarning':
    'Approving publishes this merit list for use in result generation. This cannot be undone and is never automatic -- review every entry above before approving.',
  'officer.meritList.acknowledgeApproval':
    'I have reviewed every entry above and confirm this merit list is ready to approve.',
  'officer.meritList.cancel': 'Cancel',
  'officer.meritList.approved': 'This merit list has been approved.',
  'officer.meritList.serverError': 'Something went wrong. Please try again.',
};
