...
export const BN_TRANSLATIONS: TranslationDictionary = {
  ...
  'officer.campaign.title': 'ক্যাম্পেইন কনফিগারেশন',
  'officer.campaign.loadError': 'সেই ক্যাম্পেইনটি লোড করা যায়নি। অনুগ্রহ করে আইডি পরীক্ষা করুন।',
  'officer.campaign.load.title': 'একটি বিদ্যমান ক্যাম্পেইন লোড করুন',
  'officer.campaign.load.label': 'ক্যাম্পেইন আইডি',
  'officer.campaign.load.action': 'লোড করুন',
  'officer.campaign.create.title': 'একটি নতুন ক্যাম্পেইন তৈরি করুন',
  'officer.campaign.create.name': 'ক্যাম্পেইনের নাম',
  'officer.campaign.create.programIds': 'প্রোগ্রাম আইডি',
  'officer.campaign.create.programIdsHint': 'কমা দিয়ে পৃথক করা প্রোগ্রাম আইডি।',
  'officer.campaign.create.windowStart': 'আবেদনের সময়সীমা শুরু',
  'officer.campaign.create.windowEnd': 'আবেদনের সময়সীমা শেষ',
  'officer.campaign.create.applicationFeeType': 'আবেদন ফি এর ধরন',
  'officer.campaign.create.confirmationFeeType': 'নিশ্চিতকরণ ফি এর ধরন',
  'officer.campaign.create.submit': 'ক্যাম্পেইন তৈরি করুন',
  'officer.campaign.create.validationError':
    'অনুগ্রহ করে একটি ক্যাম্পেইনের নাম এবং অন্তত একটি প্রোগ্রাম আইডি লিখুন।',
  'officer.campaign.create.serverError': 'ক্যাম্পেইন তৈরি করা যায়নি। আবার চেষ্টা করুন।',
  'officer.campaign.summary.window': 'আবেদনের সময়সীমা',
  'officer.campaign.summary.requiredDocuments': 'প্রয়োজনীয় নথি',
  'officer.campaign.eligibilityRule.title': 'একটি যোগ্যতার নিয়ম যোগ করুন',
  'officer.campaign.eligibilityRule.programId': 'প্রোগ্রাম আইডি',
  'officer.campaign.eligibilityRule.minimumScore': 'সর্বনিম্ন স্কোর',
  'officer.campaign.eligibilityRule.isGpaScale': 'স্কোর জিপিএ স্কেলে',
  'officer.campaign.eligibilityRule.requiredBoard': 'প্রয়োজনীয় বোর্ড (ঐচ্ছিক)',
  'officer.campaign.eligibilityRule.submit': 'নিয়ম যোগ করুন',
  'officer.campaign.seatQuota.title': 'একটি আসন কোটা যোগ করুন',
  'officer.campaign.seatQuota.programId': 'প্রোগ্রাম আইডি',
  'officer.campaign.seatQuota.quota': 'আসন কোটা',
  'officer.campaign.seatQuota.submit': 'কোটা যোগ করুন',
  'officer.campaign.requiredDocument.title': 'একটি প্রয়োজনীয় নথির ধরন যোগ করুন',
  'officer.campaign.requiredDocument.label': 'নথির ধরন',
  'officer.campaign.requiredDocument.submit': 'নথির ধরন যোগ করুন',

  'officer.questionBank.title': 'প্রশ্ন ব্যাংক ও পরীক্ষার নিয়ম',
  'officer.questionBank.createTest.title': 'এই ক্যাম্পেইনের জন্য ভর্তি পরীক্ষা তৈরি করুন',
  'officer.questionBank.createTest.name': 'পরীক্ষার নাম',
  'officer.questionBank.createTest.duration': 'সময়কাল (মিনিট)',
  'officer.questionBank.createTest.submit': 'পরীক্ষা তৈরি করুন',
  'officer.questionBank.totalQuestions': 'মোট প্রশ্ন',
  'officer.questionBank.totalSlots': 'মোট স্লট',
  'officer.questionBank.addQuestion.title': 'একটি প্রশ্ন যোগ করুন',
  'officer.questionBank.addQuestion.category': 'বিভাগ',
  'officer.questionBank.addQuestion.difficulty': 'কঠিনতা',
  'officer.questionBank.addQuestion.text': 'প্রশ্নের লেখা',
  'officer.questionBank.addQuestion.options': 'অপশন',
  'officer.questionBank.addQuestion.optionsHint': 'কমা দিয়ে পৃথক করা অপশন।',
  'officer.questionBank.addQuestion.isSubjective': 'এটি একটি রচনামূলক (লিখিত-উত্তর) প্রশ্ন',
  'officer.questionBank.addQuestion.maxScore': 'সর্বোচ্চ স্কোর',
  'officer.questionBank.addQuestion.submit': 'প্রশ্ন যোগ করুন',
  'officer.questionBank.selectionRule.title': 'একটি প্রশ্ন-নির্বাচন নিয়ম যোগ করুন',
  'officer.questionBank.selectionRule.difficulty': 'কঠিনতা',
  'officer.questionBank.selectionRule.count': 'প্রশ্নের সংখ্যা',
  'officer.questionBank.selectionRule.submit': 'নিয়ম যোগ করুন',
  'officer.questionBank.slot.title': 'একটি পরীক্ষার স্লট যোগ করুন',
  'officer.questionBank.slot.startAt': 'শুরুর সময়',
  'officer.questionBank.slot.endAt': 'শেষের সময়',
  'officer.questionBank.slot.capacity': 'ধারণক্ষমতা',
  'officer.questionBank.slot.submit': 'স্লট যোগ করুন',

  'officer.meritList.title': 'মেধা তালিকা',
  'officer.meritList.loading': 'মেধা তালিকা লোড হচ্ছে…',
  'officer.meritList.notFound': 'এই ক্যাম্পেইনের জন্য এখনও কোনো মেধা তালিকা তৈরি হয়নি।',
  'officer.meritList.generate': 'মেধা তালিকা তৈরি করুন',
  'officer.meritList.generating': 'তৈরি করা হচ্ছে…',
  'officer.meritList.status': 'অবস্থা',
  'officer.meritList.entries': 'এন্ট্রি',
  'officer.meritList.entry.rank': 'ক্রম',
  'officer.meritList.entry.outcome': 'ফলাফল',
  'officer.meritList.approve': 'মেধা তালিকা অনুমোদন করুন',
  'officer.meritList.approving': 'অনুমোদন করা হচ্ছে…',
  'officer.meritList.approveWarning':
    'অনুমোদন করলে এই মেধা তালিকা ফলাফল তৈরিতে ব্যবহারের জন্য প্রকাশিত হবে। এটি পূর্বাবস্থায় ফেরানো যাবে না এবং কখনোই স্বয়ংক্রিয় নয় — অনুমোদনের আগে উপরের প্রতিটি এন্ট্রি পর্যালোচনা করুন।',
  'officer.meritList.acknowledgeApproval':
    'আমি উপরের প্রতিটি এন্ট্রি পর্যালোচনা করেছি এবং নিশ্চিত করছি যে এই মেধা তালিকা অনুমোদনের জন্য প্রস্তুত।',
  'officer.meritList.cancel': 'বাতিল করুন',
  'officer.meritList.approved': 'এই মেধা তালিকা অনুমোদিত হয়েছে।',
  'officer.meritList.serverError': 'কিছু একটা ভুল হয়েছে। আবার চেষ্টা করুন।',
};
